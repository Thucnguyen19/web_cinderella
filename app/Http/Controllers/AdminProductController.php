...
class AdminProductController extends Controller
{
    ...
    public function store(ProductAddRequest $request)
    {
        ...
        //imsert tags for product
        $tagIds = []; // Khởi tạo biến $tagIds
        ...
        $colorId = []; // Khởi tạo biến $tagIds
        if (!empty($request->colors)) {
            foreach ($request->colors as $colorItem) {
                //insert to tags 
                $colorInstance = $this->color->firstOrCreate(['name' => $colorItem]);
        ...
        if (!empty($request->sizes)) {
            foreach ($request->sizes as $sizeItem) {
                $sizeIntance = $this->size->firstOrCreate(['name' => $sizeItem]);
                $sizeId[] = $sizeIntance->id;
            }
...
//dc tao tu cau lenh php artisan make:controller AdminProductController 