          ...
          <form action="{{ route('categories.update',['id'=>$category->id]) }}" method="get">
            ...
            {{-- form trong laravel bat buoc phai co @csrf để submit --}}
             ...
             <div class="mb-3">
              ...
              <input type="text" name="keywords" class="form-control" value="{{ $category->meta_keywords }}" placeholder="Nhập từ khóa cho danh mục">
            </div>
            <div class="mb-3">
              <label  class="form-label">Mô Tả danh mục </label>
              <input type="text" name="description" class="form-control" value="{{ $category->meta_des }}" placeholder="Nhập mô tả cho danh mục">
            </div>
