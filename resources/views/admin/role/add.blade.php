...
{{-- kế thừa trang admin  --}}
@section('title')
<title>Trang Thêm Vai trò( Add Role)</title>
@endsection
@section('content')
@section('css')
          ...
          <form action="{{ route('roles.store') }}" method="post" enctype="multipart/form-data" >
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="display_name"  class="form-control  @error('display_name') is-invalid @enderror" placeholder="Nhập Mô tả " value="{{ old('display_name') }}">
                  @error('display_name')
               <div class="alert alert-danger error_message">{{ $message }}</div>
                  @enderror
                </div>
