...
<div id="header-carousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        ...
        @foreach ($sliders as $key => $slider )
            {{-- class active mỗi lần chạy qua thì slider đó sẽ có active  --}}
        <div class="carousel-item {{ $key == 0 ? 'active' :'' }}" style="height: 410px;">
            <img class="img-fluid" src="{{ $slider->image_path }}" alt="{{ $slider->image_name }}">
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 700px;">
                    ...
                    <a href="{{ route('all-products') }}" class="btn btn-light py-2 px-3">SHOP NOW</a>
                </div>
            </div>
        </div>
        @endforeach
