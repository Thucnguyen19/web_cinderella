...
<div class="container-fluid pt-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-12">
            <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9945224560915882"
     crossorigin="anonymous"></script>
<ins class="adsbygoogle"
     style="display:block; text-align:center;"
     data-ad-layout="in-article"
     data-ad-format="fluid"
     data-ad-client="ca-pub-9945224560915882"
     data-ad-slot="6290900627"></ins>
<script>
            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <form action="{{ route('all-products') }}" method="get" role="search">
                        ...
                        <div class="dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                <a class="dropdown-item" href="{{ route('all-products',['sort'=>'latest']) }}">HÀNG MỚI VỀ </a>
                                <a class="dropdown-item" href="{{ route('all-products',['sort'=>'popularity']) }}">PHỔ BIẾN</a>
                                <a class="dropdown-item" href="{{ route('all-products',['sort'=>'hightToLow']) }}">GIÁ TỪ CAO XUỐNG THẤP</a>
                                <a class="dropdown-item" href="{{ route('all-products',['sort'=>'lowToHight']) }}">GIÁ TỪ THẤP LÊN CAO</a>
                            </div>
                        </div>
                    </div>
                </div>
                @foreach($allProductsFromSlider as $product )
                ...
                <div class="col-12 pb-1">
            {{ $allProductsFromSlider->links('pagination::bootstrap-4') }}
